...
* @method static \Pimcore\Model\DataObject\Customer\Listing|\Pimcore\Model\DataObject\Customer|null getByNewsletterActive(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
...
public const FIELD_NEWSLETTER_ACTIVE = 'newsletterActive';
...
{
	$this->markFieldDirty("newsletter", true);
...
* @return $this
*/
public function setNewsletterActive(?bool $newsletterActive): static
{
	$this->markFieldDirty("newsletterActive", true);
...
{
	$this->markFieldDirty("newsletterConfirmed", true);
...
{
	$this->markFieldDirty("newsletterConfirmToken", true);
...
{
	$this->markFieldDirty("profiling", true);
...
{
	$this->markFieldDirty("passwordRecoveryToken", true);
...
{
	$this->markFieldDirty("passwordRecoveryTokenDate", true);
