...
public const FIELD_RANGE_FROM = 'rangeFrom';
public const FIELD_RANGE_TO = 'rangeTo';
public const FIELD_PRE_SELECT_FROM = 'preSelectFrom';
public const FIELD_PRE_SELECT_TO = 'preSelectTo';
