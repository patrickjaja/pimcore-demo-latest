...
{
public const FIELD_TAX_ENTRY_COMBINATION_TYPE = 'taxEntryCombinationType';
public const FIELD_TAX_ENTRIES = 'taxEntries';
...
{
	$this->markFieldDirty("taxEntryCombinationType", true);
...
*/
public function getTaxEntries(): ?\Pimcore\Model\DataObject\Fieldcollection
{
	if ($this instanceof PreGetValueHookInterface && !\Pimcore::inAdmin()) {
