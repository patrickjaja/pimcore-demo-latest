...
php ./bin/console app:auto-map-json -i data/example/product_model.json -o var/class_StaticImportedProductType1_export.json -p data/prompt/model_prompt.md  --ignore-maintenance-mode
php ./bin/console pimcore:definition:import:class var/class_StaticImportedProductType1_export.json  --ignore-maintenance-mode
